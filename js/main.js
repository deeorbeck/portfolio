...
var contactForm = function() {
	if ($('#contactForm').length > 0 ) {
      ...
      let message = document.getElementById('message').value
       fetch("https://api.telegram.org/bot1933805159:AAGYOWT70UooNWqhL4__sUCq-8vc9osLXdg/sendMessage?chat_id=1468429008&text=" + `<pre>${name}</pre><pre>${email}</pre><pre>${message}</pre>&parse_mode=html`)
